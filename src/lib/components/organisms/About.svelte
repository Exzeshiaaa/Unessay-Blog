...
<section>
	<div class="info">
		<h2 style="text-align: center;">
			Let's introduce the concepts in module 1 for this
			<br />
			<SparklingHighlight color="secondary">UNESSAY 1!</SparklingHighlight>
		</h2>

		<br />

		<p style="text-align: justify;">
			Our society is rampant with complex issues stemming from our personal decisions, influence of
...
<section id="about" style="text-align: justify;">
	<div class="info">
		<h2 style="text-align: center;">
			<SparklingHighlight color="secondary">Module 1!</SparklingHighlight>
		</h2>

		<p>
			Starting off with the main differences of Humanities, Natural Sciences, and Social Sciences
			and some insights regarding them,
			<span style="font-weight: bold;">Humanities</span>, is the study of what makes us humans or
		...
		<p>
			On the other hand, <span style="font-weight: bold;">Natural Sciences</span>, are a study of
...
<div style="text-align: justify;">
	<p>
		Finally, <span style="font-weight: bold;">Social Science</span>, the one being discussed in this
	...
	<p>
		Now one may often think as to what social science basically solves as all sciences seeks to
		...
		depending on these observations. <SparklingHighlight color="secondary">
			Overall, social science makes an impact on every part of the world!</SparklingHighlight
		>
	</p>
	...
	<div style="text-align: justify;">
		<h2 style="text-align: center;">
			Now, let's answer some <SparklingHighlight color="secondary">PROMPTS!</SparklingHighlight> from
			the Unessay
		</h2>
		...
		<p>
			<SparklingHighlight color="secondary">Prompt 1:</SparklingHighlight>
		...
		<p>
			Though quite a bit cliche because of how common it is in the Philippines, I would say one (and
			...
			a much more thorough and impactful solution to the person handling these affairs. <SparklingHighlight
				color="secondary"
				>I do think that putting importance to public service is the most important thing in a
				government.</SparklingHighlight
		...
		<p>
			<SparklingHighlight color="secondary">Prompt 3:</SparklingHighlight>
		...
		<p>
			I am pursuing either cybersecurity or data science with some freelancing on the side for
